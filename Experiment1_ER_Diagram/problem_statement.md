...
### ER Diagram:
<img width="1364" height="835" alt="image" src="https://github.com/user-attachments/assets/9ce3b2bd-dee6-4787-beb1-3440979acb6c" />
...
|PERSONAL_TRAINING_SESSION |Session_ID (PK), Member_ID (FK), Trainer_ID (FK), Date, Time |For personal training sessions |
|ATTENDANCE|Attendance_ID (PK), Session_ID (FK), Status (Present/Absent)|Records session attendance   |
|PAYMENT |Payment_ID (PK), Payment_Date, Payment_Type, Amount           |For payment purpose          | 
...
### ER Diagram:
<img width="1352" height="829" alt="image" src="https://github.com/user-attachments/assets/6cea81ef-9acf-4c45-a77d-6da62b9940fc" />
...
|    Fine       |      Fine_ID (PK), Amount , Due Date                        |    Penalty amount charged   |
### Relationships and Constraints
